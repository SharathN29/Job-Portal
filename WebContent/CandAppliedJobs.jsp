  ...
  <body>
    ...
    <table class="table">
      <thead class="thead-dark">
		...
		<sql:query var="rs" dataSource="${db}">select jobid, role, compname, location, visa, comp, jd from jobs where jobid in(select jobid from candidatejob where uid=${uid})</sql:query>
